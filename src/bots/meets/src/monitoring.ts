import { EventCode, Status, status } from '../../../backend/src/db/schema';
import { trpc } from './trpc';
import { setTimeout } from 'timers/promises';

// Start heartbeat loop in the background
export const startHeartbeat = async (botId: number, abortSignal: AbortSignal) => {
...
export const reportEvent = async (botId: number, eventType: EventCode, eventData: any = null) => {
  try {
    // Report event
